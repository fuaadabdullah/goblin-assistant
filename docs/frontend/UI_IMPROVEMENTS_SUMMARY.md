...
**Responsive Layout Testing** (see `docs/operations/TESTING.md`):
...
5. `docs/operations/TESTING.md` - Testing guide
6. `docs/frontend/UI_IMPROVEMENTS_SUMMARY.md` - This file
...
1. **Manual viewport testing** (15 min)
   ...
   - Check checklist in `docs/operations/TESTING.md`
...
- Responsive guide: `docs/operations/TESTING.md`
