...
from api.routes.parse_router import ParseRequest, parse_orchestration
...
async def test_parse_orchestration_success(monkeypatch):
    ...
    monkeypatch.setattr("api.routes.parse_router.parse_natural_language", fake_parse)
...
async def test_parse_orchestration_failure(monkeypatch):
    ...
    monkeypatch.setattr("api.routes.parse_router.parse_natural_language", bad_parse)
