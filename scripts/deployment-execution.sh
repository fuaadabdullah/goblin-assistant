...
echo "  curl https://goblin-backend-dt30.onrender.com/api/v1/health"
echo ""
...
echo "  [ ] Backend /api/v1/health returns 200"
...
echo "  ✓ curl https://goblin-backend-dt30.onrender.com/api/v1/health = 200"
