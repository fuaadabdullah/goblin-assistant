...
class AzureOpenAIProvider(BaseProvider):
    ...
    def _is_v1_endpoint(self) -> bool:
        """Azure AI Foundry v1 endpoints end with /v1 or contain /openai/v1."""
        return "/openai/v1" in self._endpoint or self._endpoint.endswith("/v1")

    def _url(self, deployment: str) -> str:
        if self._is_v1_endpoint():
            # Azure AI Foundry: model passed in body, no deployment in URL
