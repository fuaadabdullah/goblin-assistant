...
- [ ] docs/operations/DEPLOYMENT_README.md — Update deployment checklist
...
### Frontend
- `apps/web/src/components/auth/ModularLoginForm.tsx` — OAuth retry + progress UI
- `apps/web/src/lib/auth-state.ts` — Token validation caching
- `apps/web/src/features/chat/hooks/useChatSession.ts` — Pagination + lazy-loading
- `apps/web/src/features/chat/api/index.ts` — Pagination params
- `apps/web/src/lib/api.ts` — Query string building
