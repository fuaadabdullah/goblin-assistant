...
Semantic text hierarchy (from `apps/web/src/theme/index.css` + Tailwind defaults).
...
- [ ] Document in docs/operations/COMPONENT_LIBRARY.md
...
**Scope**: Applies to all components in `apps/web/src/components/ui/`
