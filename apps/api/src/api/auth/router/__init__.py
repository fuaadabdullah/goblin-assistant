...
from ...core.csrf_manager import (  # noqa: F401  # re-exported for compatibility
    generate_csrf_token,
    validate_csrf_token,
)
from ...core.rate_limiter_auth import (
    check_rate_limit,  # noqa: F401  # re-exported for compatibility
)

# --- Patchable runtime dependencies ---
# Tests monkeypatch these via `api.auth.router.<name>`.
from ...storage.database import (  # noqa: F401  # patchable compatibility imports
    get_db,
    get_readonly_db,
)
