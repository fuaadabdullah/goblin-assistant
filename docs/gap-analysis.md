...
| Root and infra files | 21 | Contains runtime, Docker, compose, lockfile, hook, and docs changes that need separate ownership. |
...
There are 803 status entries after the already-created commits. This is larger
...
|---|---|
| Working tree reduced to intentional, reviewable changes | Not true; 803 status entries remain. |
