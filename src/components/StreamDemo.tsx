...
export function StreamDemo() {
  ...
  const start = () => {
    ...
    routeTaskStream("chat", { prompt: "Explain how Goblin OS works in 5 lines" }, {
      onMeta: (meta: any) => {
  ...
  return (
    <div className="stream-demo">
      ...
      <div className="connection-status">
        Connection: <span className={`connection-health ${connectionHealth || 'unknown'}`}>
      ...
      <div className="stream-info">
        This demo automatically falls back to polling if SSE is blocked by proxies.
        Check browser console for detailed streaming info.
      </div>
    </div>
  );
}
