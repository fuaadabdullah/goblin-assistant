...
echo "3. Test health endpoint: curl https://goblin-assistant-backend.onrender.com/health"
echo "4. Update frontend VITE_FASTAPI_URL with: https://goblin-assistant-backend.onrender.com"
