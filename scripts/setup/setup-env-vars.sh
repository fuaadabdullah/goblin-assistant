...
echo "  - SILICONEFLOW_API_KEY: SiliconFlow / SiliconeFlow API key"
...
echo "3. Test health endpoint: curl https://goblin-backend-dt30.onrender.com/health"
echo "4. Update frontend VITE_FASTAPI_URL with: https://goblin-backend-dt30.onrender.com"
