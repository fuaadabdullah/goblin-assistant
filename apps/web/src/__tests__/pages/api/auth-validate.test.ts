...
describe('/api/auth/validate thin proxy', () => {
  ...
  it('forwards authorization and internal key to backend /api/v1/auth/validate', async () => {
    ...
    expect(fetchMock.mock.calls[0][0]).toBe('https://backend.example/api/v1/auth/validate');
