...
```
./
├── apps/web/src/                          # Main source code directory
...
### Feature Components (`apps/web/src/components/chat/`, `dashboard/`, etc.)
...
### Constants (`apps/web/src/lib/constants/`)
...
### Design Tokens (`apps/web/src/theme/index.ts`)
- **Purpose**: Centralized design system
- **Features**: Colors, spacing, typography, shadows
- **Accessibility**: High contrast mode support

### Theme Provider (`apps/web/src/theme/components/ThemeProvider.tsx`)
...
### Import Paths
- Use absolute imports from `apps/web/src/` for better maintainability
- Example: `import { Button } from 'apps/web/src/components/ui/Button'`
