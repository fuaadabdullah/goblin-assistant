...
### Frontend
- `apps/web/src/pages/chat.tsx` - Chat page route
- `apps/web/src/screens/ChatPage.tsx` - Chat page wrapper
- `apps/web/src/features/chat/ChatScreen.tsx` - Main chat component
- `apps/web/src/features/chat/hooks/useChatSession.ts` - Chat state management
- `apps/web/src/features/chat/api/index.ts` - Chat API client
- `apps/web/src/lib/api.ts` - Base API client with axios
