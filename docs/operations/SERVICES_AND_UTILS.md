...
## 🌐 API Client (`apps/web/src/lib/services/api-client.ts`)
...
### Usage
```typescript
import { apiClient, apiEndpoints } from 'apps/web/src/lib/services/api-client';
...
## 🗄️ State Management (`apps/web/src/lib/store/`)
...
```typescript
import { useAuthStore } from 'apps/web/src/lib/store/auth-store';
...
```typescript
import { useChatStore } from 'apps/web/src/lib/store/chat-store';
...
```typescript
import { useSettingsStore } from 'apps/web/src/lib/store/settings-store';
...
## 🔧 Utilities (`apps/web/src/lib/utils/index.ts`)

Comprehensive utility functions for common operations.

### Formatting Utilities
```typescript
import { formatCurrency, formatNumber, formatBytes } from 'apps/web/src/lib/utils';
...
### Date Utilities
```typescript
import { formatDate, formatDateTime, timeAgo } from 'apps/web/src/lib/utils';
...
### String Utilities
```typescript
import { truncateString, capitalize, slugify } from 'apps/web/src/lib/utils';
...
### Array Utilities
```typescript
import { chunkArray, uniqueArray, groupBy } from 'apps/web/src/lib/utils';
...
```typescript
import { isValidEmail, isValidUrl, isValidApiKey } from 'apps/web/src/lib/utils';
...
```typescript
import { localStorageGet, localStorageSet, localStorageRemove } from 'apps/web/src/lib/utils';
...
```typescript
import { debounce, throttle, measureTime } from 'apps/web/src/lib/utils';
...
### Color Utilities
```typescript
import { hexToRgb, rgbToHex, lightenColor, darkenColor } from 'apps/web/src/lib/utils';
...
### Type Guards
```typescript
import { isString, isNumber, isObject, isArray } from 'apps/web/src/lib/utils';
...
jest.mock('apps/web/src/lib/services/api-client');
