...
from .embedding_worker import (  # noqa: E402, F401  # compatibility re-export after service definitions
    AsyncEmbeddingWorker,
    embedding_worker,
)

embedding_worker.configure_service_factory(lambda: embedding_service)
