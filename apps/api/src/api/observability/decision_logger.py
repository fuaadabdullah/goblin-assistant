...
class DecisionLogger:
    ...
    def _log_decision_structured(self, decision: DecisionRecord):
        ...
        if decision.discarded:
            logger.info("DECISION: Message discarded", extra={"decision": log_data})
        elif decision.embedded or decision.summarized:
            logger.info("DECISION: Message processed", extra={"decision": log_data})
        else:
            logger.debug("DECISION: Message stored only", extra={"decision": log_data})
