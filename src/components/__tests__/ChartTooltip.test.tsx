...
describe('ChartTooltip', () => {
  ...
  it('returns null when payload is undefined', () => {
    const { container } = render(
      <ChartTooltip active={true} label="Jan" />
    );
    expect(container.firstChild).toBeNull();
  });
  ...
  it('renders the label', () => {
    render(
      <ChartTooltip active={true} payload={[{ value: 100 }]} label="January" />
    );
  ...
  it('renders series name from entry.name', () => {
    render(
      <ChartTooltip active={true} payload={[{ name: 'Revenue', value: 500 }]} label="Q1" />
    );
  ...
  it('renders series name from dataKey when name is absent', () => {
    render(
      <ChartTooltip active={true} payload={[{ dataKey: 'sales', value: 200 }]} />
    );
  ...
  it('renders the value', () => {
    render(
      <ChartTooltip active={true} payload={[{ name: 'Sales', value: 150 }]} />
    );
