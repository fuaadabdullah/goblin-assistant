...
import { readChatMessages } from '../../../lib/chat-history';
import { queryKeys } from '../../../lib/query-keys';
import { useMessages } from './useMessages';
import { useUIState } from './useUIState';
import { useThreadSelection } from './useThreadSelection';
import { useInputEstimates } from './useInputEstimates';
...
export const useChatSession = (): ChatSessionState => {
  ...
  const uiState = useUIState({
    onSendMessage: async () => {
      // This will be wired after messagesState is available
    },
    onClearMessages: () => {
      // This will be wired after messagesState is available
    },
  ...
  }, [router.isReady, router.query.prompt, uiState]);
  ...
  // Wrap handlers to add extra behaviors
  const sendMessageWithFocus = useCallback(
  ...
  return {
    ...
    // Message handlers
    sendMessage: sendMessageWithFocus,
