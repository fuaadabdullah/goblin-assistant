...
- Full Lighthouse results: `/docs/ux/ACCESSIBILITY.md`
- Full axe-core results: `/docs/AXE_AUDIT_RESULTS.md`
- Theme system details: `/docs/frontend/THEME_SYSTEM.md`
- Implementation summary: `/docs/frontend/THEME_IMPLEMENTATION_SUMMARY.md`
